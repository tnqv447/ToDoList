        ...
        public static void Initialize(ToDoListContext context)
        {
            ...
            if (!context.Users.Any())
            {
                context.Users.AddRange(
                    new User("Nguyễn Văn A", "0123456789", "sdadad", ROLE.WORKER, USER_STATUS.ACTIVE, "nv1@gmail.com", "12345"),
                    new User("Nguyễn Văn B", "0123456789", "sdadad", ROLE.WORKER, USER_STATUS.ACTIVE, "nv2@gmail.com", "12345"),
                    new User("Nguyễn Văn C", "0123456789", "sdadad", ROLE.WORKER, USER_STATUS.ACTIVE, "nv3@gmail.com", "12345"),
                    new User("Trần thị Z", "0123456789", "sdadad", ROLE.WORKER, USER_STATUS.ACTIVE, "nv4@gmail.com", "12345"),
                    new User("Trần thị Y", "0123456789", "sdadad", ROLE.WORKER, USER_STATUS.ACTIVE, "nv5@gmail.com", "12345"),
                    new User("Nguyễn Văn D", "0123456789", "sdadad", ROLE.MANAGER, USER_STATUS.ACTIVE, "ql1@gmail.com", "12345"),
                    new User("Nguyễn Văn E", "0123456789", "sdadad", ROLE.MANAGER, USER_STATUS.ACTIVE, "ql2@gmail.com", "12345")
                );
                context.SaveChanges();
            }
